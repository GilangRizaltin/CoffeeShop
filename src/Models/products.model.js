...
const insert = (product_name,category,description,price_default, fileLink) => {
    const sql =
    "INSERT INTO products (product_name, category, description, price_default, photo) VALUES ($1, $2, $3, $4, $5) RETURNING product_name";
  const values = [product_name,category,description,price_default, fileLink] ;
  return db.query(sql, values);
};

const update = (params, body, fileLink) => {
